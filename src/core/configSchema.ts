// ============================================
// OpenSwarm - Configuration Schemas
// Zod schemas describing config.yaml. Split out of config.ts so the
// transform/load code and the schema table stay under the LOC gate.
// ============================================
...
export const DEFAULT_HEARTBEAT_INTERVAL = 30 * 60 * 1000; // 30 minutes
