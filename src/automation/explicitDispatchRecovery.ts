  ...
  for (const run of runs) {
    ...
    planned.push({
      ...
      task: {
        ...
        // This process did not make the old Linear In Progress claim. Restoring
        // rollback authority here could undo another process's live ownership;
        // it also stays compatible with queue-before-claim dispatch.
        explicitDispatchPriorState: undefined,
      },
    });
  }
  return planned;
